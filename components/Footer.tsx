          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 sm:gap-4">
              ...
              <a 
                ...
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-full glass flex items-center justify-center text-slate-400 hover:text-amber-500 hover:border-amber-500 transition-all text-sm sm:text-base"
            ...
            <ul className="space-y-3 sm:space-y-4 text-xs sm:text-sm">
              ...
              <li className="flex flex-col gap-2 sm:gap-3">
                <div className="flex gap-2 sm:gap-3">
                  ...
                  <span className="text-slate-400 break-all">Devan +60192023407</span>
                </div>
                <div className="flex gap-2 sm:gap-3">
                  <i className="fas fa-phone text-amber-500 mt-0.5 sm:mt-1 shrink-0"></i>
                  <span className="text-slate-400 break-all">KS Vinodh +60123023595</span>
                </div>
              </li>
            </ul>
          </div>
